...
export function AccessoryProductTable({ items }: { items: AccessoryProduct[] }) {
  const [removedIds, setRemovedIds] = useState<Set<string>>(new Set());
  const [pendingDelete, setPendingDelete] = useState<AccessoryProduct | null>(null);
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-secondary/60 hover:bg-secondary/60">
              ...
              <TableHead>Style / Phase</TableHead>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem
                        render={<Link href={`/admin/accessories/${item.id}`} />}
                      >
                        <Pencil />
                        Edit
                      </DropdownMenuItem>
