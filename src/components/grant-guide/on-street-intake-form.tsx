      ...
      <Card className="border border-border shadow-lg shadow-primary/5 ring-primary/10">
        <CardContent>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Field label="Property address (where the chargepoint will be installed)" required className="sm:col-span-2">
              <Input name="address" required placeholder="Property address" />
            </Field>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Field label="Name of landlord / freeholder / agent">
              <Input name="thirdPartyName" placeholder="Optional" />
            </Field>
            <Field label="Their contact details">
              <Input name="thirdPartyContact" placeholder="Optional" />
            </Field>
          ...
          <div className="flex flex-col gap-4">
            <Field label="Where is the on-street parking located relative to your home?" required>
              <Textarea
                ...
                required
                rows={2}
                placeholder="e.g. directly outside the property, on the opposite side of the road, nearest lamppost, etc."
              />
            </Field>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Field label="Vehicle make and model" required>
              <Input name="vehicleModel" required placeholder="Vehicle make and model" />
            </Field>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Field label="Name of your local council / highways authority" required className="sm:col-span-2">
              <Input name="lhaName" required placeholder="Name of your local council / highways authority" />
            </Field>
            <Field label="Status of your LHA consent application" required>
              <Select name="lhaStatus">
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select…" />
                </SelectTrigger>
                <SelectContent>
