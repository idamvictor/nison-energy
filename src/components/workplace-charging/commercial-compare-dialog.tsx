...
const rows: { label: string; value: (p: CommercialProduct) => React.ReactNode }[] = [
  ...
  {
    label: "Warranty",
    value: (p) => commercialProductDetails[p.id]?.warranty ?? "—",
  },
];

export function CommercialCompareDialog({
  open,
  onOpenChange,
  productIds,
  onRemove,
